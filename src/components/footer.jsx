			...
			<div className="w-full max-w-[1600px] pt-12 pb-8 md:px-8 md:pt-16 md:max-w-[1228px] lg:px-12 lg:pt-20 lg:max-w-[1600px]">
				...
				<div className="mt-10 rounded-xl border border-amber-500/25 bg-amber-500/8 px-5 py-4">
					<p className="text-[0.8125rem] leading-6 text-amber-300/80">
						<strong className="text-amber-900 font-semibold">Demo project &mdash; not affiliated with Coinbase, Inc.</strong>{' '}
						<strong className="text-amber-900 font-semibold">This application was built as a student assignment for educational purposes only.</strong>{' '}
						<strong className="text-amber-900 font-semibold">Do not enter real personal information, financial data, or real cryptocurrency wallet addresses.</strong>{' '}
						<strong className="text-amber-900 font-semibold">All balances, transactions, and data shown are simulated and have no real-world value.</strong>
					</p>
				</div>
